      ...
      <div class="addbox">
          <div class="addClass">
              <form action="#" @submit="submitMessage">
                  ...
                  <div class="formbody">
                     <label for="file">
                          <span>设置封面：</span><div><input id="file" type="file" accept=".png, .jpg, .jpeg"></div>
                     </label>
                      <div class="inputnode">
                          <p><span>*</span> 用于课程资源包的显示或作为您共享资源之后的宣传图</p>
                          <p><span>*</span> 支持.jpg .jpeg .png等格式</p>
                          <p><span>*</span> 图片小于4MB</p>
                      </div>
                  </div>
