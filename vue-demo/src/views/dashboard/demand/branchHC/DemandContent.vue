	...
	<div class="demand-content-container">
		...
		<div class="demand-content">
			...
			<template>
				...
				>
					...
					<span slot="action" slot-scope="text, item">
						...
						<a @click="delClick(item)" v-if="state !== 2"><a-icon style="color:#F58585;font-size:20px" type="delete" /></a>
					</span>
					<!-- <p
			...
			>
				...
				<a-form :form="reviewForm" @submit="handleReviewSubmit">
					<a-row>
						<a-col :span="24">
							<a-form-item
								label="需求审核人"
			...
			<a-modal
				centered
				v-model="toReviewVisible"
				title="需求审核"
				width="530px"
				wrapClassName="toreview-modal"
				:bodyStyle="{
					height: '260px',
					overflowY: 'auto'
				}"
			>
				<template slot="footer">
					...
					<a-button
						...
						style="background: #22B8CF;border: #22B8CF"
						type="primary"
						@click="toReviewSubmit"
						>提交</a-button
					>
				</template>
				<a-form :form="toReviewForm" @submit="toReviewSubmit">
					<a-row>
						<a-col :span="24">
							<a-form-item
								label="是否通过审核"
	...
	methods: {
		...
		handleOrganSubmit(e) {
			...
			this.staffForm.validateFields((error, fieldsValue) => {
				...
				console.log(this.listQuery.jobType)
